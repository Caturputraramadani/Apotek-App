...
<body>
    ...
    <div id="receipt">
        ...
        <center id="top">
            <div class="info">
                <h2>Apotek Magic Heals</h2>
            </div>
        </center>
        <div id="mid">
            <div class="info">
                <p>
                    Alamat : FairyCity, Chestnut three </br>
                    Email : apotekmagicheals@gmail.com </br>
                    Phone : 999-999-111 </br>
                </p>
            </div>
        </div>
        <div id="bot">
            ...
            <div id="legalcopy">
                <p class="legal">
                    <strong>Terima kasih atas pembelian Anda!</strong> Lorem ipsum dolor sit, amet consectetur
                    adipisicing elit. Expedita autem veniam iusto perspiciatis eos dolor in non quaerat aspernatur id!
                </p>
            </div>
        </div>
    </div>
